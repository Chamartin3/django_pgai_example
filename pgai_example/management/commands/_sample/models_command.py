...
def prepare_models_data() -> ModelListData:
    ...
    for sample_model in ctx.models.sample_model:
        try:
            ...
            # Get embedding configuration directly from sample_model
            embedding_model = sample_model.embedding_model
            dimensions = sample_model.embedding_dimensions

            # Get all vectorized fields for detailed config
            vectorized_fields = [
                field
